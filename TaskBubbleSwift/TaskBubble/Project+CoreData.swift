...
// TaskBubble
//
// ─── Core Data model setup (do this ONCE in Xcode) ───────────────────────────
// In TaskBubble.xcdatamodeld add entity "Project" with attributes:
//   id            UUID
//   name          String
//   notes         String   (optional)
...
//
// Relationships:
//   Project  → tasks   (To-Many, Item,    inverse: project, delete rule: Cascade)
//   Item     → project (To-One,  Project, inverse: tasks,   delete rule: Nullify, optional)
// ─────────────────────────────────────────────────────────────────────────────
...
// MARK: - Colour palette for the picker
