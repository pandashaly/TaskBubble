...
struct AppFonts {
    ...
    static let title = Font.custom("Montserrat-SemiBold", size: 24)
    static let cardTitle = Font.custom("Montserrat-Medium", size: 18)
    static let taskText = Font.custom("Montserrat-Regular", size: 16)
    static let label = Font.custom("Montserrat-Regular", size: 13)
    static let button = Font.custom("Montserrat-Medium", size: 16)
    static let pillText = Font.custom("Montserrat-Medium", size: 12)
//
